...
import com.kujtimhoxha.plugins.base.Maker;
...
import com.kujtimhoxha.plugins.model.github.GithubMilestone;
...
public class GithubIssuePostMaker implements Maker<GithubIssuePost> {
    ...
    public final GithubIssuePost make(final Issue issue,
                                      final File file,
                                      final Configurations conf) throws IOException, GithubException {
        ...
        if(issue.getMilestone()!=null){
            ...
            if (githubMilestone != null) {
                issuePost.setMilestone(String.valueOf(githubMilestone.getId()));
            }
        }
